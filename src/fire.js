(function (G, M) {
    ...
    utils =
...

        {
            ...
            */
             ...
             * @function
             */
            createURL: (URL && URL.createObjectURL.bind(URL)) || (webkitURL &&
            ...
            * @function
            */
            revokeURL: (URL || webkitURL).revokeObjectURL,
            ...
            */
            ...
            set: function (a, b) {
                ...
                if (b !== false) for (var j in a) fn.isF(this[j]) && this[j](a[j]);
                return this;
            ...
            cset: function (a, b, n) {
                ...
                if (fn.isA(b)) {
                    ...
                    for (var i in a) (this[i] !== undefined && !fn.isF(this[i])) && (this[i] = a[i]);
                    for (var j in a) fn.isF(this[j]) && this[j](a[j]);
                }
                return this;
            },
            ...
            horizontal: function (a) {
                ...
                var ax = this._width;//*this.anchorX;
    ...
    var TextureShader = _class({
        ...
        constructor: function (_super, shaderManager, vertexSrc, fragmentSrc, customUniforms, customAttributes) {
            var uniforms = {
                ...
                projectionMatrix: {
                    type: 'mat3', value: new Float32Array([1, 0, 0,
                        0, 1, 0,
                        0, 0, 1])
                }
            };
    ...
    var DisplayObject = _class({
        ...
        setPosition: function (a) {
            if (a.h) {
                fn.horizontal.call(this, a.h);
            }
            if (a.v) {
                fn.vertical.call(this, a.v);
            }
            return this;
        },
    ...
    _class({
        ...
        constructor: function (_super, a) {
            ...
            if (a.aabb) {
                ...
                var value = a.aabb, l = value && value.length;
        ...
        // }
            ...
            aabb: {
                ...
                set: function (value) {
                    var l = value && value.length;
                    if (l == 1) {
                        this._aabb = [value, value, value, value];
                    } else if (l == 2) {
                        this._aabb = [value[0], value[1], value[0], value[1]];
                    } else if (l == 4) {
                        this._aabb = value;
            ...
            anchorY: {
                get: function () {
                    return this.pivot.y / this._height;
                },
                set: function (value) {
    ...
    var Text = _class({
        ...
        updateText: function () {
            var _font = this.tyle + " " + this.variant + " " + this.weight + " " + this._size + "px " + this.font;
            ...
            this.context.font = this.tyle + " " + this.variant + " " + this.weight + " " + this.size + "px " + this._font;
            ...
            if (this.shadow) {
                ...
                for (i = 0; i < lines.length; i++) {
                    ...
                    if (this.align === 'right') {
                        ...
                        // console.log('center');
                        //  this.context.textBaseline = this.align;
            ...
            for (i = 0; i < lines.length; i++) {
                ...
                if (this.align === 'right') {
                    ...
                    // console.log( maxLineWidth, lineWidths[i], 2);
                    // this.context.textBaseline = this.align;
                    linePositionX += (maxLineWidth - lineWidths[i]) / 2;
                }
    ...
    var Controller = _class({
        ...
        constructor: function (ops) {
            ...
            this.fns = ops.fns;
            this.name = ops.name || miao.uid;
            g.controller[this.name] = this;
        },
        init: function (the) {

            var selector = g.selector;
            ...
            for (i in control) {
                ...
                if (!obj) continue;
                for (var o in co) {
                    obj.on(o, fns[co[o]].bind(obj, this));
                }
            }
            g.selector = selector;
        }
    ...
    var View = _class({
        ...
        _init: function (n) {
            ...
            this.controller = miao.getController(this.controller);
